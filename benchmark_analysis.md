...
**Old implementation:** `benchmark_old_no_utf8.txt`
**New implementation:** `benchmark_new_utf8.txt`

<details>
<summary><h2>Column Definitions</h2></summary>

| Column        | Description                                                                                                                                                |
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ns/op**     | Nanoseconds per operation - how long each function call takes. Lower is better. 1000 ns = 1 microsecond, 1,000,000 ns = 1 millisecond.                     |
| **B/op**      | Bytes allocated per operation - total heap memory allocated per function call. Lower is better. Indicates memory efficiency.                               |
| **allocs/op** | Number of heap allocations per operation - how many times memory was allocated. Lower is better. Each allocation has overhead and creates work for the GC. |
| **min-ns/op** | Fastest (minimum) time recorded across 10 benchmark runs.                                                                                                  |
| **max-ns/op** | Slowest (maximum) time recorded across 10 benchmark runs.                                                                                                  |
| **avg-ns/op** | Average time across all 10 benchmark runs.                                                                                                                 |
| **Diff**      | Absolute difference in nanoseconds between old and new implementation.                                                                                     |
| **Diff %**    | Percentage change from old to new implementation.                                                                                                          |
...
<details>
<summary><h2>OLD IMPLEMENTATION (no UTF-8 handling)</h2></summary>
...
<details>
<summary><h2>NEW IMPLEMENTATION (with UTF-8 handling)</h2></summary>
...
<details>
<summary><h2>COMPARISON: OLD (no UTF-8) vs NEW (with UTF-8)</h2></summary>
